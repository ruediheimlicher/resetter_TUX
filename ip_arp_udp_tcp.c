...
static  *client_additionalheaderline PROGMEM;
static char *client_postval;
static  *client_urlbuf PROGMEM;
static char *client_urlbuf_var;
static  *client_hoststr PROGMEM;
...
uint16_t fill_tcp_data_p(uint8_t *buf,uint16_t pos, const const char *progmem_s)
{
        char c;
...
void fill_buf_p(uint8_t *buf,uint16_t len, const const char *progmem_s)
{
        while (len){
...
//
void client_browse_url(const char *urlbuf, char *urlbuf_varpart, const char *hoststr,void (*callback)(uint8_t,uint16_t,uint16_t))
{
...
void client_http_post(const char *urlbuf, const char *hoststr, const char *additionalheaderline,char *postval,void (*callback)(uint8_t,uint16_t,uint16_t))
{
        client_urlbuf=urlbuf;
        client_hoststr=hoststr;
